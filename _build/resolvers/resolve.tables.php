...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('wrapyoutube_core_path', null,
                    $modx->getOption('core_path') . 'components/wrapyoutube/') . 'model/';
            $modx->addPackage('wrapyoutube', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/wrapyoutube/model/schema/wrapyoutube.mysql.schema.xml';
